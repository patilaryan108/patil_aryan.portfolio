...
export default function Project() {
    return (
        <>
            <div id='projects' style={{ maxWidth: "100vw", width: "100%", boxSizing: "border-box", overflowX: "hidden", padding: "0 10px" }}>
                <div className="project-background" >
                    ...
                    <div style={{ display: "flex", justifyContent: "center", margin: "45px 0px 80px 0px", flexWrap: "wrap", maxWidth: "100%", overflowX: "hidden", boxSizing: "border-box", gap: "20px" }}>
